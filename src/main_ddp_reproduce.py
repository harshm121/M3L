...
def get_args(args_cmd):
    ...
    test_checkpoint = args_cmd.checkpoint
    ...
    args['test_checkpoint'] = test_checkpoint
    args.eval_source = args.test_source
    return args
...
def main(rank, args, port):
    ...
    framework.evaluate(None, verbose = args.verbose, test_checkpoint_path = args['test_checkpoint'])
...
if __name__ == '__main__':    
    ...
    parser.add_argument('--checkpoint', type=int, help="epoch to test")
