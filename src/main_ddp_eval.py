...
def get_args(args_cmd):
    ...
    args.snapshot_dir = f'/srv/flash1/hmaheshwari7/semi-supervised/segmentation/Multi-modal-SSL-Segmentation/snapshots/{args.data}/{args.ssl_framework}/1-{args.labeled_ratio}/{args.seg_model}/{args.base_model}/{args.run_name}'
...
def main(rank, args, port):
    ...
    if rank == 0:
        ...
        framework.evaluate(None, verbose = args.verbose)
